...
void insertCSVValues(RBTree &tree, const std::string &filename) {
...
int main() {
 ...
 // Obter o tempo atual antes de executar o código
  ...
  auto time_elapsed_ms = std::chrono::duration_cast<std::chrono::milliseconds>(end_time - start_time);
	

  // Imprimir o tempo de execução na saída padrão
